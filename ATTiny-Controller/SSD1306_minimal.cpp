...
void SSD1306_Mini::printChar(char ch)
{
    ...
    {
      data[0] = getFlash(BasicFont, (i - 45) * 5 );
      data[1] = getFlash(BasicFont, (i - 45) * 5 + 1);
      data[2] = getFlash(BasicFont, (i - 45) * 5 + 2);
      data[3] = getFlash(BasicFont, (i - 45) * 5 + 3);
      data[4] = getFlash(BasicFont, (i - 45) * 5 + 4);    
    }
